!(function(e) {
  ...
  function(e, t, n) {
    ...
    i()(document).ready(function() {
      i()(".close-icon").click(function(e) {
        e.preventDefault(), i()(".mobile-nav-sidebar").removeClass("visible");
      }),
        i()(".burger-icon").click(function(e) {
          e.preventDefault(),
            e.stopPropagation(),
            i()(".mobile-nav-sidebar").addClass("visible");
        }),
        i()(window).on("click", function(e) {
          i()(".mobile-nav-sidebar").removeClass("visible");
        }),
        i()(".mobile-nav-sidebar").click(function(e) {
          e.stopPropagation();
        });
    });
    n(3);
